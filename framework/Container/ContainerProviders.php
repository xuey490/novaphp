...
class ContainerProviders
{
     ...
     */
    public function loadAll(ContainerConfigurator $configurator, string $appProviderDir = null , string $namespaceBase): void
    {
    ...
    protected function getComposerNamespacePath(string $namespace): ?string
    {
        ...
        if (!file_exists($autoloadFile)) return null;
